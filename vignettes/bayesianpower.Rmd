...
Hypothesized population means have to be defined under $H_1$ and $H_2$, also if $H_u$ or $H_c$ are considered as $H_2$. The population means can be standardized, or, alternatively, the group specific standard deviations can be set under `sd1` and `sd2`. 
